 ...
 *  @version 1.0.0
 *  **/
public interface EventResults<ResultAnalysis, ResultResultHandle, ResultRecordAnalysis, ResultRecordHandle, ParametersCache> {
    ...
    public Optional<ResultResultHandle> resultResult(Optional<ResultAnalysis> resultAnalysis, Optional<ParametersCache> parametersCache);
