...
public final class EventResultCache extends MultimapCacheImpl<String, String> implements BeforehandCharacteristicShell<MultimapCache<String, String>> {
	...
	* **/
	...
	public void initialize(BaseCharacteristic<MultimapCache<String, String>> cacheArg) {
		multimapCache = cacheArg.characteristic().get();
		resultStateInit();
	}
