...
public abstract class BaseTransactionAssembleAnalysisImpl implements TransactionAssembleAnalysis {
	...
	@Override
	public Optional<TransactionAssembleAnalysisHandle> analysis(Optional<Collection<Event>> eventsList, Optional<Cache<String, String>> interactionCacheArg) {
		return transactionAssembleAnalysis.analysis(eventsList, interactionCacheArg);
	}
