...
public class EventResultAnalysisHandleResources implements EventResultAnalysisHandle {
    ...
    public EventResultAnalysisHandleResources(Optional<Cache<String, String>> cache, Optional<EventResultsResultAnalysisHandle> eventResultsResuleAnalysisHandleArg){
