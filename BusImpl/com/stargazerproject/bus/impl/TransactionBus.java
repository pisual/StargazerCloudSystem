...
public class TransactionBus extends BusImpl<Transaction> implements StanderCharacteristicShell<Bus<Transaction>>{
	...
	@Override
	public void initialize(Optional<Bus<Transaction>> busArg) {
		bus = busArg.get();
	}
